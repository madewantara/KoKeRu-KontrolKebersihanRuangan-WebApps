        ...
        <form class="form" method="post" action="{{ route('password.email') }}">
            ...
            <div class="card card-login card-white">
                ...
                <div class="card-body">
                    ...
                    <div class="input-group{{ $errors->has('email') ? ' has-danger' : '' }} mb-5">
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-primary btn-lg btn-block mb-2">{{ _('Send Password Reset Link') }}</button>
                </div>
            </div>
        </form>
    </div>
