@extends('layouts.appguest', ['class' => 'login-page', 'page' => _('Login Page'), 'contentClass' => 'login-page'])
        ...
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-white">
                <div class="card-header text-center mt-4 mb-4">
                    <h1 class="card-title" style="color:#ff4a57">{{ _('Log in') }}</h1>
                </div>
                <div class="card-body">
                ...
                <div class="card-footer">
                    ...
                    <div class="pull-right">
                        <h6>
                            <a href="{{ route('password.request') }}" class="link footer-link" style="color: #ff4a57">{{ _('Forgot password?') }}</a>
                        </h6>
                    </div>
                </div>
            </div>
